            ...
            children: [
              Padding(
                ...
                child: TextField(
                  ...
                  onSubmitted: (value) {
                    context
                        .read<GalleryBloc>()
                        .add(RefreshPhotosEvent(query: value.trim()));
                  },
                  onChanged: (value) {
                    context
                        .read<GalleryBloc>()
              ...
              Expanded(
                child: SmartRefresher(
                  scrollController:
                      context.read<GalleryBloc>().scrollController,
                  ...
                  onRefresh: () async {
                    context.read<GalleryBloc>().add(RefreshPhotosEvent(
                        query: _searchController.text.trim()));
                  },
                  onLoading: () async {
                    context.read<GalleryBloc>().add(FetchAllPhotosEvent(
                        query: _searchController.text.trim()));
                  },
