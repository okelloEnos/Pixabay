...
class PixDataProvider {
  ...
  PixDataProvider({required Dio dio}) : _dio = dio;
  //
  // // create a new quote
  // Future<void> createQuoteRequest({required QuoteEntity quote}) async {
  ...
  // get all quotes
  Future<dynamic> fetchAllPixRequest() async {
    var url = "${Api.pixabayBaseUrl}/quotes";
    var response = await _dio.get(url,
        // options: Options(headers: {
        //   'Authorization':
        //       'Bearer ${locator.get<SharedPrefsRepositoryImpl>().getLoginToken}'
