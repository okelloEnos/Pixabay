...
//     if (!_loaded) {
//       // simple loading placeholder while prefs load
...
//       home: HomePage(isDark: _isDark, onThemeChanged: _toggleTheme),
//     );
//   }
// }
//
...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text('Custom Theme Switch'),
//         actions: [
//           Padding(
...
//       body: Center(
//         child: Text(
//           'Hello — toggle the theme from the app bar!',
